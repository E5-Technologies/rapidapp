...
export const equipmentCatalog: ManufacturerCatalog[] = [
  ...
  { name: "Endress+Hauser", category: "Automation", catalogUrls: ["https://www.us.endress.com/en"] },
  ...
  { name: "GE", category: "Automation", catalogUrls: ["https://www.gemeasurement.com/"] },
  { name: "Panametrics", category: "Automation", catalogUrls: ["https://www.gemeasurement.com/"] },
  ...
  // Pumps
  { name: "Goulds Pumps", category: "Pumps", catalogUrls: ["https://pdf.directindustry.com/pdf/goulds-pumps/pump-selection-guide/20610-15402.html"], logoUrl: "itt-goulds" },
  { name: "Xylem", category: "Pumps", catalogUrls: ["https://pdf.directindustry.com/pdf/goulds-pumps/pump-selection-guide/20610-15402.html"], logoUrl: "xylem" },
  { name: "Flowserve", category: "Pumps", catalogUrls: ["https://www.flowserve.com/products/products-catalog/pumps/"], logoUrl: "flowserve" },
  { name: "Sulzer", category: "Pumps", catalogUrls: ["https://www.sulzer.com/en/products/pumps/"], logoUrl: "sulzer" },
  { name: "KSB", category: "Pumps", catalogUrls: ["https://www.ksb.com/en-us/product"], logoUrl: "ksb" },
